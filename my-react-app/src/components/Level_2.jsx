...
import backgroundImage from '../assets/Level-2.svg';
...
const Level_2 = () => {
    ...
    useEffect(() => {
        ...
        if (!hasSpokenOnce.current) {
            speak('The left one is bigger or smaller than the right one?');
    ...
    return (
        <div className="level2-game">
            <img src={backgroundImage} alt="Level 2 Background" className="background-image" />
